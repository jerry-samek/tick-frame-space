...
This means that the decision can be **fallible**: it may close a horizon that does not correspond to the optimal image of reality.
...
- **Cardinality >1**: only with multiple independent observers do separate branches of reality emerge (*Observer-Separated Multiverse Principle*).
