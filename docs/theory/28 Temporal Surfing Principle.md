...
## Abstract
Persistence in cellular automata and tick‑frame universes is not defined by static occupation of space, but by continual renewal across ticks. Entities must “surf time” — projecting themselves forward at each update — to remain within existence. This principle generalizes survival across discrete substrates, from Conway’s *Game of Life* to horizon‑buffered tick‑frame models.
...
In each case, survival is not about static presence but about *temporal renewal*. This insight forms the foundation of the Temporal Surfing Principle.
