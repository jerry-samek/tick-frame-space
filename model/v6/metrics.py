"""Metrics tracking for v6 simulation -- CSV output for analysis.

V6 additions: phase counts (learning, execution, orbiting),
orbit closures, orbit failures.
"""
...
class MetricsTracker:
    ...
    def __init__(self, output_dir: str):
        ...
        self._summary_writer.writerow([
            ...
            "learning_count", "execution_count", "orbiting_count",
            "orbit_closures", "orbit_failures",
        ])
    ...
    def log(self, world) -> None:
        ...
        self._summary_writer.writerow([
            ...
            execution,
            orbiting,
            world.orbit_closures,
            world.orbit_failures,
        ])
