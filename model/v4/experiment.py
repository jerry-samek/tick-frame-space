"""V4 Experiment runner: Pygame visualization + headless mode.
...
def run_headless(args):
    ...
    print(f"V4 Headless (memory model): radius={WORLD_RADIUS}, seeds={args.seeds}, "
...
def run_visual(args):
    ...
    pygame.display.set_caption("V4 Gamma Field (Memory Model)")
...
def main():
    parser = argparse.ArgumentParser(description="V4 Gamma Field Experiment (Memory Model)")
