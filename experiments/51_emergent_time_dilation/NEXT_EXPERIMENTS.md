...
### Objective
Complete experiments #52-55 to **definitively validate or falsify** whether tick-frame physics can reproduce GR/SR from computational substrate alone.
...
### Hypothesis
Event horizon radius varies with observer capacity (tick_budget_capacity), making horizons observer-dependent rather than objective.
...
2. Implement explicit observer model with tick_budget_capacity
3. Use same massive planet (7,000 entities) from v11
...
- ✅ Observer A sees horizon at r_A
- ✅ Observer B sees horizon at r_B
...
- ✅ Tick-frame physics validated as complete alternative to GR/SR
...
- v3 becomes different project (not physics)
