"""
V14 Entity - Entity with tick skipping for time dilation.
...
V14 addition: skip_accumulator field
- Tracks ticks accumulated while skipping
- When entity acts (doesn't skip), imprints once for entire accumulated segment
- This is the core mechanism for time dilation without extra parameters

Author: V14 Implementation
Date: 2026-01-31
Based on: V13 entity.py + skip_accumulator
"""
