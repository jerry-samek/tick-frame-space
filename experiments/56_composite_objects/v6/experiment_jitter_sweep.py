...
def run_jitter_test(config_name: str, config):
    ...
    # Run evolution
    print(f"Evolving for 1,000 ticks...")
    print()
...
def main():
    ...
    configs = {
        ...
        #"jitter_0.10": JitterSweepConfig10(),              # 10%
        #"jitter_0.11": JitterSweepConfig11(),              # 10%
        "jitter_0.16": JitterSweepConfig16(),              # 10%
        "jitter_0.17": JitterSweepConfig17(),              # 10%
        "jitter_0.18": JitterSweepConfig18(),              # 10%
        "jitter_0.19": JitterSweepConfig19(),              # 10%,
    }

    # Override num_ticks to 1000 for quick validation
    ...
    # Save results
    with open("results/jitter_sweep_1k.16-19.json", "w") as f:
        json.dump(results, f, indent=2)

    print("Results saved to results/jitter_sweep_1k.16-19.json")
    print("=" * 70)
