"""
Threshold-finding sweep: Narrow down the precise alpha_0 value where commits begin.
Testing values between 50 and 100.
"""
...
# -----------------------------
# Threshold-finding sweep
# -----------------------------
alpha_0_values = [50.0, 60.0, 70.0, 80.0, 90.0, 100.0]
alpha_1_values = [0.0]
gamma_values = [0.001]
M_values = [1]
...
# -----------------------------
print("=" * 80)
print("THRESHOLD-FINDING PARAMETER SWEEP")
print("=" * 80)
print(f"Started at: {datetime.now().strftime('%Y-%m-%d %H:%M:%S')}")
print(f"\nSearching for the threshold where agent commits begin to appear...")
            ...
            for M in M_values:
                ...
                if stats['agent_commit_count'] > 0:
                    print(f"alpha_0={alpha_0:5.1f}: COMMITS={stats['agent_commit_count']:3d}, "
                          ...
                          f"max_sal={stats['max_salience']:8.2f}")
                else:
...
if runs_without_commits and runs_with_commits:
    ...
    print(f"  Try higher alpha_0 values.")

# Save results
output_file = "parameter_sweep_threshold_results.json"
