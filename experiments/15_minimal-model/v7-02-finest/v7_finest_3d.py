"""
v8a: Saturation Boundary Detection - 3D (Finest)
...
GAMMA_VALUES = [0.004,0.0045,0.00475,0.005]  # Boundary region
...
NUM_WORKERS = 11
OUTPUT_CSV = "v7a_finest_3d_results.csv"
OUTPUT_JSON = "v7a_finest_3d_results.json"
...
if __name__ == "__main__":
    print("=" * 80)
    print("v7a: SATURATION BOUNDARY DETECTION - 3D (Finest)")
    print("=" * 80)
