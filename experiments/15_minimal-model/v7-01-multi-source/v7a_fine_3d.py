"""
v8a: Saturation Boundary Detection - 3D (Fine)

Tests extended T range with fine damping values to map saturation boundary.
...
TIME_HORIZONS = [200.0, 500.0]  # Extended to find T_sat
...
NUM_WORKERS = 11
OUTPUT_CSV = "v7a_fine_3d_results.csv"
OUTPUT_JSON = "v7a_fine_3d_results.json"
...
if __name__ == "__main__":
    print("=" * 80)
    print("v8a: SATURATION BOUNDARY DETECTION - 3D (FINE)")
    print("=" * 80)
    ...
    print("See V8A_SATURATION_ANALYSIS.md for detailed analysis")
