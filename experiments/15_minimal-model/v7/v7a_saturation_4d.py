"""
v7a: Saturation Boundary Detection - 4D (Focused)

Tests extended T range with focused damping values to map saturation boundary.
...
# Focused parameter set for saturation boundary detection
GAMMA_VALUES = [0.001, 0.003, 0.005]  # Boundary region
TIME_HORIZONS = [100.0, 200.0, 500.0, 1000.0, 2000.0]  # Extended to find T_sat
ALPHA_0_VALUES = [0.8, 1.2, 1.8, 2.4]  # Representative sampling
NUM_SOURCES_LIST = [2]  # Single value (known to be independent)
GEOMETRIES = ['symmetric']  # Single value (known to be neutral)
PHASE_OFFSETS = [0]  # Single value (known to be neutral)

NUM_WORKERS = 11
OUTPUT_CSV = "v7a_saturation_4d_results.csv"
OUTPUT_JSON = "v7a_saturation_4d_results.json"
...
if __name__ == "__main__":
    print("=" * 80)
    print("v7a: SATURATION BOUNDARY DETECTION - 4D (FOCUSED)")
    print("=" * 80)
