...
v7 fix: tangential and gravity are ACCELERATION (bend the forward
direction) not velocity (added to forward). Each routing decision
bends the forward by a small amount. The bends accumulate into orbit.
"""
