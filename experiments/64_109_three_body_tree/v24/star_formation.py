...
star_mass × 10 (1000000.0). All other mechanics unchanged from v23.
The gradient at r=25 with M=1000 ≈ gradient at r=8 with M=100.

Uses v21 graph infrastructure.

Usage:
    python -u v24/star_formation.py --measure-force --weighted-spread --no-mass-loss
    python -u v24/star_formation.py --phase2 --ticks 60000 --weighted-spread --no-mass-loss --tag orbit
...
def main():
    ...
    parser.add_argument('--star-mass', type=float, default=1000000.0)
