"""v22 Phase 0: Star Formation — Gamma gradient establishment.

Verify that a distributed star (117 nodes, body_radius=5.0) builds a
1/r-like gamma gradient at orbital distances before any planet is released.

Uses v21 graph infrastructure.  Outputs a radial gamma profile plot.

Usage:
    python -u v22/star_formation.py --ticks 5000
    python -u v22/star_formation.py --ticks 10000 --tag long
...
def main():
    ...
    parser.add_argument('--warm-up', type=int, default=20000,
