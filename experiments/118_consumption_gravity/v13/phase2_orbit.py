...
Three mechanisms combined. Star should bind (density gradient + Same rule).
Planet should orbit (length momentum on boundary connectors).
NO tangential kick.
"""
...
def plot(rows, initial_dist, graph, spectrum, center, hop_dist):
    ...
    fig.suptitle('Experiment 118 v13 -- Density + Same Rule + Length Momentum (NO KICK)',
                 fontsize=13)
