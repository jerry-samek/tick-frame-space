"""
Newtonian entity logic for Experiment 118 v11.

Newton's laws on the graph:
  1st: Forward continuation as default. No deposits = straight line.
  2nd: Incoming deposits during charging phase deflect the path.

Three states: CHARGING (accumulate deflection) -> ROUTING -> IN_TRANSIT.
No deadlock: forward default means entities always have a direction.
"""
