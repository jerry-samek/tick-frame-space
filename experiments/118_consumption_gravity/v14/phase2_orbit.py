#!/usr/bin/env python3
"""
Experiment 118 v14 -- Larger Graph (50k nodes, R=80)

Same v14 mechanism on a bigger stage. Star at thermal equilibrium r~14
is now 18% of the universe (was 70%). Planet placed OUTSIDE the star.
First test of exterior orbits.
"""
...
WARMUP_TICKS = 300000   # longer — deposits need to reach r=25+
SIM_TICKS = 300000
MEASURE_EVERY = 3000
LOG_EVERY = 30000
...
def place_planet_cluster(graph, star_com, star_radius, n_nodes):
    ...
    min_dist = star_radius + 10.0  # well outside star body
...
def plot(rows, initial_dist, graph, spectrum, center, hop_dist):
    ...
    fig.suptitle('Experiment 118 v14 -- Larger Graph (50k nodes, R=80) (NO KICK)',
                 fontsize=13)
