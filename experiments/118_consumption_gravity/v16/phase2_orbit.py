#!/usr/bin/env python3
"""
Experiment 118 v16 -- Same Consumes Different (Connectors Can Shrink)

v16 base + consumption rule: Same deposits consume one Different deposit.
Connectors shrink from Same traffic, grow from Different traffic.
The tug-of-war creates equilibrium orbital distances.
NO tangential kick.
"""
