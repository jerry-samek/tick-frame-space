...
class Substrate:
    def __init__(self, graph, initial_state):
        ...
        self.state = initial_state  # dict: node -> 0/1
    ...
    def grow(self, parity_map):
        ...
        for node, parity in parity_map.items():
            if parity == 1:
                ...
                # nový uzel začíná neaktivní
                self.state[new_node] = 0
    ...
    def collapse_to_last_edge(self):
        ...
        self.state = {
            parent: self.state.get(parent, 0),
    ...
    def collapse_to_last_n_edges(self, n=10):
        ...
        for a, b in selected:
            ...
            new_state[a] = self.state.get(a, 0)
            new_state[b] = self.state.get(b, 0)
